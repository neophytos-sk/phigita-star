...
CONST static char *optionTable[] = {
    ...
    "CURLOPT_SSH_KNOWNHOSTS", "CURLOPT_SSH_KEYFUNCTION","CURLOPT_NOPROXY",
    (char *)NULL
};
...
CONST static char *configTable[] = {
    ...
    "-sshknownhosts",     "-sshkeyproc",         "-noproxy",
    (char *) NULL
};
...
CONST static char *proxyTypeTable[] = {
    "http", "http1.0","socks4", "socks4a", "socks5", "socks5hostname", (char *)NULL
};
