...
set conf(includedirs) [list [file join $dir ../c]]

set conf(csources) [file join $dir ../c/critbit.c]
set conf(cheaders) [file join $dir ../c/critbit.h]
...
set conf(cinit) {
    ...
    Tcl_CreateObjCommand(ip, "::cbt::bytes", cbt_BytesCmd, NULL, NULL);
