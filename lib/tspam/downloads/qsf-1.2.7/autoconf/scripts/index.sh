...
echo "$CTAGDATA" | while read FUNC FILE LINENUM REST; do
	echo $ECHO_N '<LI><CODE CLASS="funcname">'"$ECHO_C"
	echo $ECHO_N '<A HREF="#func-'"$FUNC"'---'"$FILE"'">'"$FUNC"'</A></CODE> '"$ECHO_C"
...
echo "$CTAGDATA" | while read FUNC FILE LINENUM REST; do
	...
	echo '<P><HR WIDTH="100%"></P>'
	echo '<P ALIGN="LEFT">'
	echo $ECHO_N '<CODE CLASS="funcname"><A NAME="func-'"$FUNC"'---'"$FILE"'">'"$ECHO_C"
	echo $ECHO_N "$FUNC"'</A></CODE> '"$ECHO_C"
	echo $ECHO_N '[<CODE CLASS="filename"><A HREF="#file-'"$FILE"'">'"$ECHO_C"
	echo "$FILE"'</A></CODE>]'
	echo '</P>'
...
for FILE in $FILELIST; do
	...
	echo $ECHO_N '<LI><CODE CLASS="filename">'"$ECHO_C"
