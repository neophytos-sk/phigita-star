/* @(#)root/clib:$Id: Demangle.c 23679 2008-05-07 14:10:06Z rdm $ */
/* Author: */
...
#if 0
static int
demangle_method_args (struct work_stuff *work, const char **, string *);
#endif

static int
demangle_template (struct work_stuff *work, const char **, string *, string *);
...
static int
arm_special (struct work_stuff *, const char **, string *);
