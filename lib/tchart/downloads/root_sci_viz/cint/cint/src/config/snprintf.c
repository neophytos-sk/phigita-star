/* @(#)root/clib:$Id: snprintf.c 35482 2010-09-20 19:08:47Z pcanal $ */
...
#include "config/snprintf.h"            /* for CINT_NEED_SNPRINTF */

#if defined(CINT_NEED_SNPRINTF) || defined(SNTEST)
...
#endif /* defined(CINT_NEED_SNPRINTF) || defined(SNTEST) */
