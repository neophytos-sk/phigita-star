/********************************************************************
* cint/cint/lib/dll_stl/G__cpp_queue.h
* CAUTION: DON'T CHANGE THIS FILE. THIS FILE IS AUTOMATICALLY GENERATED
*          FROM HEADER FILES LISTED IN G__setup_cpp_environmentXXX().
*          CHANGE THOSE HEADER FILES AND REGENERATE THIS FILE.
********************************************************************/
#ifdef __CINT__
#error cint/cint/lib/dll_stl/G__cpp_queue.h/C is only for compilation. Abort cint.
#endif
#include <stddef.h>
#include <stdio.h>
#include <stdlib.h>
...
#include "cint/cint/lib/dll_stl/que.h"
#include <algorithm>
namespace std { }
using namespace std;
...
extern G__linked_taginfo G__LN_queuelEintcOdequelEintcOallocatorlEintgRsPgRsPgR;
...
extern G__linked_taginfo G__LN_queuelElongcOdequelElongcOallocatorlElonggRsPgRsPgR;
...
extern G__linked_taginfo G__LN_queuelEdoublecOdequelEdoublecOallocatorlEdoublegRsPgRsPgR;
...
extern G__linked_taginfo G__LN_queuelEvoidmUcOdequelEvoidmUcOallocatorlEvoidmUgRsPgRsPgR;
...
extern G__linked_taginfo G__LN_queuelEcharmUcOdequelEcharmUcOallocatorlEcharmUgRsPgRsPgR;
...
extern G__linked_taginfo G__LN_queuelEstringcOdequelEstringcOallocatorlEstringgRsPgRsPgR;
...
typedef queue<int,deque<int,allocator<int> > > G__queuelEintcOdequelEintcOallocatorlEintgRsPgRsPgR;
...
typedef queue<long,deque<long,allocator<long> > > G__queuelElongcOdequelElongcOallocatorlElonggRsPgRsPgR;
...
typedef queue<double,deque<double,allocator<double> > > G__queuelEdoublecOdequelEdoublecOallocatorlEdoublegRsPgRsPgR;
...
typedef queue<void*,deque<void*,allocator<void*> > > G__queuelEvoidmUcOdequelEvoidmUcOallocatorlEvoidmUgRsPgRsPgR;
...
typedef queue<char*,deque<char*,allocator<char*> > > G__queuelEcharmUcOdequelEcharmUcOallocatorlEcharmUgRsPgRsPgR;
...
typedef queue<string,deque<string,allocator<string> > > G__queuelEstringcOdequelEstringcOallocatorlEstringgRsPgRsPgR;
