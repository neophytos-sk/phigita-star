...
source [file join $libdir curl-ext/tcl/module-curl-ext.tcl]
...
doc_return 200 text/plain "DATA=[dict get $spec data]\n\n gsl_multifit_linear(obs=$obs,degree=$degree) coeff= $coeff \n cov = $cov \n estimate=[join $estimate \n\t]\n  forecast=\n\t[join $new_forecast \n\t]\n\n\t \n\n [print_ta_table table plain]"
