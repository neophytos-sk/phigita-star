...
foreach e $nodes {
    ...
    lappend images ${e}:
    foreach contentNode [${e} selectNodes {*[local-name()='content']}] {
	lappend images [::util::map "::util::wgetFile news/images" [::util::getImageList [$contentNode asHTML]]]
    }

}

doc_return 200 text/html $images
return
