...
alphaList=[isDominant,isDominant,1-isDominant];

for i = 1:length(assignments)
  A=assignments(i,:);

  if A(phenotypeIndex)==1
    phenotypeFactor.val(i) = alphaList(A(genotypeIndex));
  else
    phenotypeFactor.val(i) = 1-alphaList(A(genotypeIndex));
  end
