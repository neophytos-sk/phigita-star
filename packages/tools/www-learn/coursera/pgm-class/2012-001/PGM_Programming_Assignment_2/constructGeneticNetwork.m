...
for i=1:numPeople
  ...
  if parents(1) == 0
    ...
    genotypeVarParentOne = parents(1);
    genotypeVarParentTwo = parents(2);
    factorList(i) = genotypeGivenParentsGenotypesFactor(numAlleles, genotypeVar, genotypeVarParentOne, genotypeVarParentTwo);
  end

  % factor for person's phenotype
  phenotypeVar = numPeople+i;
  factorList(numPeople+i) = phenotypeGivenGenotypeFactor(alphaList,genotypeVar,phenotypeVar);
