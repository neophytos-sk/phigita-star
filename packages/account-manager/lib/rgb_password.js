...
rgb_password.init = function(config) {
    var id = config["applyTo"];
    ...
    rgb_password.__password = password;

    password.selector.onkeyup = rgb_color_boxes;
    rgb_color_boxes(); // run once upon initialization
}

window["rgb_password_init"]=rgb_password.init;
