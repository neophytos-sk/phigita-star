...
SearchBox.init = function(config) {
    ...
    config['applyTo']=$(xo.getCssName(config["applyTo"]));
    config['displayTo']=$(xo.getCssName(config["displayTo"]));
...
SearchBox.show = function(t,results){
	...
	if (!SearchBox.__resultEl[i]) {
	    SearchBox.__resultEl[i] = DH.createDom({"tag":"div","cn":[{"tag":"div","cls":xo.getCssName("suggest-title"),"html":title},{"tag":"div","cls":xo.getCssName("suggest-url"),"html":url}]},SearchBox.__divEl);
