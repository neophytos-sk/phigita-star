...
proc db_qd_internal_get_cache {fullquery_name} {
    ...
    # Why? set fullquery_array [nsv_get OACS_FULLQUERIES $fullquery_name]
...
proc db_qd_internal_parse_init {stuff_to_parse file_path} {
    ...
    set root_node [xml_doc_get_root_node $parsed_doc]

    # Check that it's a queryset
    if {[xml_node_get_name $root_node] != "queryset"} {
	db_qd_log Error "OH OH, error, first node is [xml_node_get_name $root_node]"
