...
proc install_footer {} {
    return "<hr>
<a href=\"mailto:gatekeepers@phigita.net\"><address>gatekeepers@phigita.net</address></a>
...
proc install_handler { conn arg why } {
    ...
    set path "[nsv_get acs_properties root_directory]/packages/bootstrap-installer/installer/$script.tcl"
    if { ![info exists path] } {
	install_return 404 "Not found" "
