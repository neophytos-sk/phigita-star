...
-- $Id: subsite-callbacks-create.sql,v 1.1.1.1 2002/11/22 09:47:32 nkd Exp $
...
--        select nextval(''t_acs_object_id_seq'') into v_callback_id from dual;
--     else
...
create or replace function subsite_callback__delete(integer)
returns integer as '
declare
