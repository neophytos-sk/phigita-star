...
create or replace function acs_object_type_insert_tr () returns opaque as '
declare
...
create or replace function acs_object_type_update_tr () returns opaque as '
declare
        v_parent_sk     varbit default null;
        v_max_value     integer;
        v_rec           record;
...
create or replace function acs_attribute__add_description (varchar,varchar,varchar,text)
returns integer as '
declare
...
create or replace function acs_attribute__drop_description (varchar,varchar,varchar)
returns integer as '
declare
