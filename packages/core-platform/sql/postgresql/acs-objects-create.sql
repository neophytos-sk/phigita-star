...
create or replace function acs_objects_mod_ip_insert_tr () returns opaque as '
begin
...
create or replace function acs_objects_last_mod_update_tr () returns opaque as '
begin
...
create or replace function acs_objects_update_tr () returns opaque as '
declare
        v_parent_sk     varbit default null;
        v_max_value     integer;
        ctx_id          integer;
...
create or replace function acs_objects_context_id_del_tr () returns opaque as '
begin
  delete from acs_object_context_index
  where object_id = old.object_id;
...
create or replace function acs_object__new (integer,varchar) returns integer as '
declare
...
create or replace function acs_object__check_object_ancestors (integer,integer,integer)
returns boolean as '
declare
...
create or replace function acs_object__check_object_descendants (integer,integer,integer)
returns boolean as '
declare
...
create or replace function acs_object__update_last_modified (integer, timestamptz)
 returns integer as '
 declare
     acs_object__update_last_modified__object_id     alias for $1;
