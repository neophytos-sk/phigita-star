...
(as opposed to using the UI, the system can read the pkgIndex.xml file and update
...
comment on column apm_package_types.singleton_p is '
 ...
 restricted to the control-panel/ subsite.
';
...
begin
  ...
  insert into apm_package_file_types(file_type_key, pretty_name) values(''pdl_model'', ''PDL Model'');
...
create or replace function apm_package__enable (integer) returns integer as '
declare
...
create or replace function apm_package__disable (integer) returns integer as '
declare
...
create or replace function apm_package_version__new (integer,varchar,varchar,varchar,varchar,varchar,varchar,timestamptz,varchar,varchar,boolean,boolean) returns integer as '
declare
...
-- function edit
create or replace function apm_package_version__edit (integer,integer,varchar,varchar,varchar,varchar,varchar,timestamptz,varchar,varchar,boolean,boolean)
returns integer as '
declare
...
create or replace function apm_package_version__remove_file (integer,varchar)
returns integer as '
declare
