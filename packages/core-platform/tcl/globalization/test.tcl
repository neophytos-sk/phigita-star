...
ad_library {
    ...
    @cvs-id $Id: localization-data-init.tcl,v 1.3 2002/11/18 17:58:35 lars Exp $
}
...
nsv_set locale el_GR,day {{†Ê†õ†ñ†é†á†ê†Þ} {Monday} {Tuesday} {Wednesday} {Thursday} {Friday} {Saturday}}
...
nsv_set locale el_GR,mon {{Ianouariou} {Fevrouariou} {Martiou} {Apriliou} {Maiou} {Iouniou} {Iouliou} {Augustou} {Septembriou} {Octobriou} {November} {December}}
