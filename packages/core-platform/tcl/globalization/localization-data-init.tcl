...
# el_GR
nsv_set locale el_GR,abday {{Κυρ} {Δευ} {Τριτ} {Τετ} {Πεμ} {Παρ} {Σαβ}}
nsv_set locale el_GR,abmon {{Ιαν} {Φεβ} {Μαρ} {Απρ} {Μαιος} {Ιουν} {Ιουλ} {Αυγ} {Σεπ} {Οκτ} {Νοε} {Δεκ}}
nsv_set locale el_GR,am_str "πμ"
nsv_set locale el_GR,currency_symbol "£"
nsv_set locale el_GR,day {{Κυριακή} {Δευτέρα} {Τρίτη} {Τετάρτη} {Πέμπτη} {Παρασκευή} {Σάββατο}}
...
nsv_set locale el_GR,int_curr_symbol "EUR "
nsv_set locale el_GR,int_frac_digits 2
nsv_set locale el_GR,mon_decimal_point "."
nsv_set locale el_GR,mon_grouping {3 3 }
nsv_set locale el_GR,mon {{Ιανουαρίου} {Φεβρουαρίου} {Μαρτίου} {Απριλίου} {Μαΐου} {Ιουνίου} {Ιουλίου} {Αυγούστου} {Σεπτεμβρίου} {Οκτωβρίου} {Νοεμβρίου} {Δεκεμβρίου}}
...
nsv_set locale el_GR,pm_str "μμ"
