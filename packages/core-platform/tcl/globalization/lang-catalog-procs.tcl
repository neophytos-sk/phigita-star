...
ad_library {
    ...
    @cvs-id $Id: lang-catalog-procs.tcl,v 1.3 2002/11/07 12:13:51 peterm Exp $
}
...
namespace eval lang::catalog {
    ...
    ad_proc -public export_all_to_files {} {
	...
	# here: temporary hack
	set package_key core-platform

        db_foreach get_all_locales {} {
...
"
    ...
    ad_proc -public import_from_files { package_key } {
        ...
        foreach msg_file $msg_file_list {
            ...
            if { [array exists messages_array] } { 
