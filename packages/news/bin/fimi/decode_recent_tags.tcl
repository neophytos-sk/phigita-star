...
puts {copy xo.xo__buzz_recent_tags from stdin with delimiter E'\t';}
...
puts [subst -nobackslashes -novariables {--create index xo__buzz_recent_tags on xo.xo__buzz_recent_tags using gist (itemset_ts_vector);
--create index xo__buzz_itemset_occ__idx on xo.xo__buzz_recent_tags(occurrence);
update xo.xo__buzz_recent_tags set itemset_ts_vector=to_tsvector('simple',itemset_tags)||to_tsvector('[default_text_search_config]',itemset_tags);
end;
