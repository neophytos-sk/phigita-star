...
${o} perform
set cost 5
set tt [::ttext::Worker new -volatile -init -set tagValues(object) $cost -set tagValues(param) $cost -set tagValues(embed) $cost]
...
URL: <a href="$url">$url</a>
    ...
    Objects: [::util::getObjectList [[$tt maxNode] asHTML]]
    HTML:
