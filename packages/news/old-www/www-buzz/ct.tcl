...
if { $s eq {} } {
    ns_returnmoved http://buzz.phigita.net/
    return
}

try {
    set connObject [DB_Connection new -pool newsdb -volatile_p yes]
	...
	<title>buzz.phigita.net</title>
	<link rel="alternate" type="application/rss+xml" title="phigita.net News in Greek" href="http://buzz.phigita.net/?output=rss" />
	<script>
	<!--
...
function ct() {
	...
	-->
        ...
        <body onload="ct();">
	Thank you for using <a title="News in Greek" href="http://buzz.phigita.net/">http://buzz.phigita.net/</a>. Redirecting...
	</body>
	</html>
    }]
...
set comment {
    ...
    ns_log notice "IP=[ad_conn peeraddr] s=$s Error: $trymsg"
} finally {
    $connObject destroy
} trymsg