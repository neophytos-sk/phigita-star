/**********************************************************************
 * $Id: startUp_winman.js,v 1.1 2006/12/12 18:09:16 lbecchi Exp $
 *
...
function drawWindowManager(){
	...
	myLegendWin.pushContent(getRawObject('legendDiv'));
	
	myBlackboardWin.setValues('header',2,vieportH-155,vieportW/3*2,150,true,true);
	myBlackboardWin.pushContent(getRawObject('header'));
