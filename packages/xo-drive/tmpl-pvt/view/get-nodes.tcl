...
set nodes [list]
lappend nodes [list text " Items not in folders" leaf true cls z-static-folder iconCls z-itemsnotinfolders]]
foreach o [$data set result] {
    lappend nodes [list text [$o set name] label_id [$o set id] cnt_entries ([$o set cnt_entries]) color [$o set color] leaf true cls z-folder]
}

set json [::util::list2json $nodes M] 
