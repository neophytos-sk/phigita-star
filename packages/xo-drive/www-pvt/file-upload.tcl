...
set filename [::util::coalesce [ns_set get $form upload_file_name] [ns_set get $form upload_file]]
set user_id [ad_conn user_id]

#::xo::kit::log tmpfile=$tmpfile filename=$filename form=[::xo::ns::printset $form]
