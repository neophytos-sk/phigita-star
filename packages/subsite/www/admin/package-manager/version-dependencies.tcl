ad_page_contract {
    ...
    @date 17 April 2000
    @cvs-id $Id: version-dependencies.tcl,v 1.1.1.1 2002/11/22 09:47:32 nkd Exp $
} {
    {version_id:integer}
}
...
foreach dependency_type { provide require } {
	...
	doc_body_append "<li>[string totitle $dependency_type]s service <b>$service_uri</b>, version $service_version (<a href=\"version-dependency-remove?[export_url_vars dependency_id version_id dependency_type]\">remove</a>)\n"
