ad_page_contract {
    ...
    @date 17 April 2000
    @cvs-id $Id: old-package-add-2.tcl,v 1.1.1.1 2002/11/22 09:47:32 nkd Exp $
} {
    layer_id:integer
    package_key
    pretty_name
...
db_transaction {
    ...
    apm_package_register_2 $package_key $pretty_name $pretty_plural $package_uri \
	    $package_type $initial_install_p $singleton_p $layer_id
    # Insert the version
