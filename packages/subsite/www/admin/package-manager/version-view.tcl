ad_page_contract {
    ...
    @date 17 April 2000
    @cvs-id $Id: version-view.tcl,v 1.1.1.1 2002/11/22 09:47:32 nkd Exp $
} {
    {version_id:integer}
}
...
if { ![info exists installed_version_id] } {
    if { !$downloaded_p } {
	set status "No version of this package is installed: there is no <tt>pkgIndex.info</tt> file in the
...
if { ![info exists installed_version_id] || $installed_version_id == $version_id && \
    ...
    # of the package.
    doc_body_append "<li><a href=\"version-generate-info?version_id=$version_id&write_p=1\">Write an XML package specification to the <tt>packages/$package_key/pkgIndex.info</tt> file</a>\n"
}
