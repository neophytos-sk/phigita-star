...
{if((theBase<tt)&&(ww>0))
_DiagramTarget.document.write("<div "+this.EventActions+"style='"+_cursor(theOnClickAction)+"position:absolute;left:0px;top:0px;font-size:1pt;line-height:1pt;'><img src='o_"+theColor+".gif' width="+ww+"px height="+eval(tt-theBase)+"px style='vertical-align:bottom'></div>");if(((theY0<theY1)&&(theX0<theX1))||((theY0>theY1)&&(theX0>theX1)))
_DiagramTarget.document.write("<div "+this.EventActions+"style='"+_cursor(theOnClickAction)+"position:absolute;left:0px;top:"+eval(tt-theBase)+"px;font-size:1pt;line-height:1pt;'><img src='q_"+theColor+".gif' width="+ww+"px height="+hh+"px style='vertical-align:bottom'></div>");if(((theY0>theY1)&&(theX0<theX1))||((theY0<theY1)&&(theX0>theX1)))
...
divtext+="<div "+this.EventActions+"style='"+this.Cursor+"position:absolute;left:0px;top:0px;font-size:1pt;line-height:1pt;'><img src='o_"+this.Color+".gif' width="+ww+"px height="+eval(tt-this.Base)+"px style='vertical-align:bottom'></div>";if(((this.Y0<this.Y1)&&(this.X0<this.X1))||((this.Y0>this.Y1)&&(this.X0>this.X1)))
divtext+="<div "+this.EventActions+"style='"+this.Cursor+"position:absolute;left:0px;top:"+eval(tt-this.Base)+"px;font-size:1pt;line-height:1pt;'><img src='q_"+this.Color+".gif' width="+ww+"px height="+hh+"px style='vertical-align:bottom'></div>";if(((this.Y0>this.Y1)&&(this.X0<this.X1))||((this.Y0<this.Y1)&&(this.X0>this.X1)))
