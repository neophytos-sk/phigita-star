...
var logo = 'http://localhost:8090/images/bookmarklet-logo-1.gif';
...
function failsafe(err) {
		...
		var loc = "http://localhost:8090/bookmarklet/index.html?url=" +encodeURIComponent(sf_url)+ "&description=" +encodeURIComponent(sf_description);
		if (err != null) {
			loc += "&exception=" + err;
		}
