...
namespace inscope ::xo::ui {
	...
	Tablet ds0 \
	    ...
	    -remoteSort true \
	    -autoLoad true \
	    -select "id name description hstore" \
	    -type ::bboard::Message_Type \
	    -limit 25 \
	    -defaultSortField name \
	    -fields [util::list2json {id name description hstore}] \
	    -name_field_map {
		name name
	    }
	...
	xg.ColumnModel cm0 -map {sm0} -config {[
				     sm0,
				     {id:'name',header: "Type", sortable: true, dataIndex: 'name'},
				     {id:'description',header: "Description", width: 160, dataIndex: 'description'}
				    ]}
