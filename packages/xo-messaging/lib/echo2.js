...
echo.init = function(config) {
    ...
    var commentEl = $("echo_comment_text");
...
echo.attach = function(o) {
    ...
    echo.clearFileInputField('attachment_1');
    xo.log(attachmentEl);
}
