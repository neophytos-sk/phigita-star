...
su - ${USER} -c '/opt/postgresql/bin/pg_dump --no-owner --format=c --file=/web/data/backup/atlas.service-phgt-0.pg_dump service-phgt-0'
cp /web/data/backup/atlas.service-phgt-0.pg_dump /web/tmp/
