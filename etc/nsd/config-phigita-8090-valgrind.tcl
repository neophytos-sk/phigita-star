...
set storage_port          7001 ;# config-phigita-8001.tcl for http service 8000 storage_port=7000

# The hostname and address should be set to actual values.

if {1} {
    set hostname               localhost
    set address                0.0.0.0 ;# [ns_info address]
} else {
...
ns_param maxkeepalive       0 ;# 32
ns_param keepalivetimeout   0 ;# 4
...
ns_param   shutdowntimeout    60  ;# Seconds to wait on shutdown if open connections
...
ns_param stacksize          [expr {256*1024}] ;#1024000 ;# 2048000 ;# 8192000
...
ns_param is_mail_server_p   1
ns_param is_ping_p          no
ns_param is_chat_p          no
ns_param start_request_monitor_p         yes
ns_param performance_mode_p 1
...
ns_param connsperthread     1
ns_param minthreads        $minthreads
ns_param maxthreads        $maxthreads
...
ns_param threadtimeout     1800       ;# Idle threads die at this rate

# Miscellaneous
ns_param   checkmodifiedsince false   ;# Check url if no If-Modified-Since?
...
ns_param   cachemaxsize    [expr 2*1024*1024] ;# Size of fastpath cache
...
ns_section "ns/server/${server}/adp/compress"
ns_param   enable          false
ns_param   level           4
ns_param   minsize         0
...
#ns_param agendadb "AgendaDB Pool"
#ns_param geoipdb "GEOIPDB Pool"
#ns_param basedb "BaseDB Pool"
...
#set datasource aias::agendadb
set datasource localhost::agendadb
ns_section ns/db/pool/agendadb
ns_param maxidle            0
ns_param maxopen            0
ns_param Connections        ${db_pool_connections}
ns_param Verbose            Off
...
#set datasource ada::geoipdb
set datasource localhost::geoipdb
set password ""
ns_section ns/db/pool/geoipdb 
ns_param MaxIdle            0
ns_param MaxOpen            0
ns_param Connections        ${db_pool_connections}
ns_param Verbose            Off
...
#ns_param Pools              "main,00-pool2,00-pool3,bookdb,newsdb,echodb,agendadb,geoipdb"
#ns_param Pools              "main,00-pool2,00-pool3,bookdb,echodb,agendadb,geoipdb"
#ns_param Pools              "main,00-pool2,00-pool3,bookdb,agendadb,geoipdb"
ns_param Pools              "main,00-pool2,bookdb"
...
ns_param        writersize              [expr {1024 * 1024}] ;# 100000 ;# 1048576
...
ns_param   extendedheaders "COOKIE Host Referer X-Forwarded-For"
...
ns_param libthread       ${homedir}/lib/thread2.6.7/libthread2.6.7.so
...
set nssmtpd_address 0.0.0.0 ;# 127.0.0.1
