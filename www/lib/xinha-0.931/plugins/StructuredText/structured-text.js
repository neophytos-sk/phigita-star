...
HTMLArea.prototype.fullwordSelection = function (spaces)  {
	if (Xinha.is_ie)	//to handle IE
	{
		this.fullwordSelectionIE(spaces);
		return;
	}
...
HTMLArea.prototype.fullwordSelectionIE = function (spaces)  {
	var sel = this._getSelection();
	var range = this._createRange(sel);
...
/*StructuredText.prototype.getStructuredText = function() {
        return "hello structured text";
};*/
