...
# lines
Drawable -drawable d1 -xrange 0,11 -yrange 0,10 -coord 10,10 -dimensions 60,40
AxesTicsLabels -title Lines -drawable d1 -majortics f -labels f
PlotLines -table t -drawable d1 -xfield x -yfield y -linewidth 0.5

# points
Drawable -drawable d23 -xrange 0,11 -yrange 0,10 -coord 80,10 -dimensions 60,40
...
# linespoints
Drawable -drawable d2 -xrange 0,11 -yrange 0,10 -coord 150,10 -dimensions 60,40
...
# filled 
Drawable -drawable d3 -xrange 0,11 -yrange 0,10 -coord 220,10 -dimensions 60,40
...
# error bars
Drawable -drawable da -xrange 0,11 -yrange 0,10 -coord 10,80 -dimensions 60,40
AxesTicsLabels -title "Error Bars" -drawable da -majortics f -labels f
PlotVerticalIntervals -table t -drawable da -xfield x -ylofield ylo -yhifield yhi 
PlotPoints -table t -drawable da -xfield x -yfield y -style circle -linewidth 0.5 -size 0.5

# box plots
Drawable -drawable db -xrange 0,11 -yrange 0,10 -coord 80,80 -dimensions 60,40
...
# hintervals
Drawable -drawable dc -xrange 0,10 -yrange 0,11 -coord 150,80 -dimensions 60,40
...
# functions
Drawable -drawable dd -xrange 0,10 -yrange 0,11 -coord 220,80 -dimensions 60,40
...
# bars
Drawable -drawable d5 -xrange 0,11 -yrange 0,10 -coord 10,150 -dimensions 60,40
...
# stacked bars
Drawable -drawable d55 -xrange 0,11 -yrange 0,10 -coord 80,150 -dimensions 60,40
...
# bars
Drawable -drawable d6 -xrange 0,10 -yrange 0,11 -coord 150,150 -dimensions 60,40
