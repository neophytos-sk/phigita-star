...
# do major copy graph
Drawable -drawable copy -coord 35,30 -dimensions 350,110 -xrange 0,4500 -yrange 0,8000
...
Drawable -drawable copyc1 -coord 135,90 -dimensions 40,40 -xrange 700,720 -yrange 0,6000
...
Drawable -drawable copyc2 -coord 325,70 -dimensions 40,60 -xrange 3280,3310 -yrange 0,6000
Table -table copyc2 -columns c0,c1
TableSelect -from copy -to copyc2 -where {($c0>=3280) && ($c0<=3310)}
AxesTicsLabels -drawable copyc2 -ticmajorsize 2 -xauto ,,20 -yauto ,,2000 -ylabeltimes 0.001 -ylabelformat "%d" -linecolor gray -fontsize 6
PlotLines -drawable copyc2 -table copyc2 -xfield c0 -yfield c1 -linewidth 0.25

# finally, do nocopy graph
Drawable -drawable nocopy -coord 35,160 -dimensions 350,110 -xrange 0,4500 -yrange 0,8000
