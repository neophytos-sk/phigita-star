...
Drawable -xrange 89,102 -yrange -15,30 -xoff 0 -width 300 -yoff 25 -height 100 
...
PlotVerticalBars -table lt -xfield x -yfield y -fill t -fillcolor    red -barwidth 0.7 -linewidth 0 -yloval 0 \
    -labelfield y -labelplace s -labelanchor c,h -labelcolor white -labelfont Helvetica-Bold -labelsize 7.0 

# a bit of a hack to get around that we don't support date fields (yet)
AxesTicsLabels -style x -xauto 90,99,1 -majortics f -xaxisposition 0 -linewidth 0.5 -fontsize 8.0 -xlabelformat "'%s" -xlabelshift 0,-30 -linecolor white -fontcolor white
AxesTicsLabels -style x -xmanual "100,'00 : 101,'01" -majortics f -xaxisposition 0 -linewidth 0.5 -fontsize 8.0 -xlabelshift 0,-30 -axis f -fontcolor white
