...
# define the canvas
PsCanvas -title "barwithdevs.eps" -width 3.5 -height 2.75 -units inches
...
# plot the bars
PlotVerticalBars -table bar -xfield c0 -yfield c1 -barwidth 0.9 \
    -fill t -fillstyle solid -fillcolor gray -legend Widgets

# and now add the deviations (precomputed in the third and fourth columns)
...
PsRender -file Output/barwithdevs.eps
