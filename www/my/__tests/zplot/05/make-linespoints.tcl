...
# define the canvas
PsCanvas -title "linespoints.eps" -width 3.5 -height 2.75 -units inches
...
PlotLines -table line2 -xfield x -yfield y -linecolor lblue
...
# all done
PsRender -file Output/linespoints.eps
