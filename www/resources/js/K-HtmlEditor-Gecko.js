...
Xinha.prototype._xo_updateToolbar = function(noStatus) {
 ...
 var _xo_block_type = text ? '__TEXT__' : this.getBlockType();
...
//sourceRange.selectNode(Ext.get(this._doc.body).first().dom);
...
//	return false;
//}
// more checks needed here, test case: backspace to the beginning of the document (style instead of normal paragraph)
